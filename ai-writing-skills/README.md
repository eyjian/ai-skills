...
| **输出** | 3-5 个选题方案（标题、文章类型、目标读者、核心卖点、差异化角度、参考资源） |
...
| **审查维度** | ①事实准确性 ②逻辑完整性 ③概念辨析 ④类比恰当性 ⑤代码质量 ⑥风格一致性 ⑦配图检查 ⑧引用出处 |
| **原则** | 只标问题+给建议，不直接改文字 |
...
| 禁止学术腔 | 不用“本文旨在”、“综上所述”、“笔者认为” || 结尾格式 | `*本文由 AI 原生生成，内容经本人构思并把控，仅代表个人观点，欢迎交流探讨。*` |
