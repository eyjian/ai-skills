...
| **输出** | 3-5 个选题方案（标题、目标读者、核心卖点、参考资源） |
...
| **工具** | `web_search`、`read_file` |
| **规则** | 每篇至少 3 个对比表格、至少 1 个类比、3-5 章、每章不超 3 小节 |
...
| **风格铁律** | 口语化、短句（≤30字）、每段≤5行、禁止学术腔、每篇≥3个对比表格 |
...
| **审查维度** | ①事实准确性 ②逻辑完整性 ③概念辨析 ④类比恰当性 ⑤代码质量 ⑥风格一致性 |
| **原则** | 只标问题+给建议，不直接改文字 |
...
| **润色维度** | ①标题/引言优化 ②术语统一 ③Markdown格式 ④文字打磨 ⑤前后文一致性 ⑥结尾检查 |
